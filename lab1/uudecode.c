...
/*
 ...
 NOTE: 
    First argument must be in range 0 to 255.
    Second argument is referenced twice. 

 Programmers may incorporate any or all code into their programs, 
 giving proper credit within the source. Publication of the
 source routines is permitted so long as credit is given to:
   Stephen Satchell of Satchell Evaluations and 
   Chuck Forsberg of Omen Technology.
*/
...
/*
  Purpose:
    ...
    MAIN is the main program for UUDECODE.
*/
{
  FILE *in;
  FILE *out;
...
/*
  Purpose:
    ...
    DECN decodes characters, avoiding ebcdic problem chars and spaces.
 */
{
 switch (ch)
  {
...
/*
  Purpose:
    ...
    DECODE copies from in to out, decoding as it goes along. 
*/
{
  char buf[80];
  char *bp;
